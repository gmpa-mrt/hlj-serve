...
router.get('/users/:id',authJWT, UserController.user_show)
...
router.patch('/users/update/:id',authJWT, UserController.user_update)
router.delete('/users/delete/:id',authJWT, UserController.user_destroy)
